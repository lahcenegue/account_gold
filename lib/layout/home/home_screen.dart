    ...
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
            ...
            body: cubit.homeDataModel?.send == null
                ? Center(
                            ...
                            Expanded(
                              child: GridView.builder(
                                ...
                                itemBuilder: (context, index) => itemWidget(
                                  name: cubit.homeDataModel!.all![index].name!,
                                  page: cubit.homeDataModel!.all![index].page!,
                                  url: cubit.homeDataModel!.all![index].url!,
                                  index: index,
                                  id: "",
                                  type: cubit.homeDataModel!.all![index].url!,
                                ),
                              ),
                            ),
                          ],
      ...
      onTap: () {
        if (page == "company") {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => AddInvoiceScreen(url: url)));
        } else if (page == "show") {
