...
class InvoiceScreen extends StatefulWidget {
  ...
  final String? type;
  final String? name;
  const InvoiceScreen({Key? key, required this.id, this.type, this.name})
      : super(key: key);
    ...
    return BlocConsumer<AppCubit, AppStates>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
              ...
              IconButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                InvoiceSearchScreen(id: widget.id)));
                  },
                  icon: Icon(
                    Icons.search,
                    size: 28,
          ...
          floatingActionButton: cubit.invoiceModel?.buttonAdd != null &&
                  cubit.invoiceModel!.buttonAdd == "ok"
              ...
              : null,
          body: cubit.invoiceModel?.balance != null
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Center(
                                  child: Text(
                                cubit.invoiceModel!.balance!.toString(),
                                  ...
                                  Center(
                                      child: SizedBox(
                                          width: cubit.invoiceModel!
                                              ...
                                              : null,
                                          child: Text(
                                            cubit.invoiceModel!.allBillmon1!
                                                .toString(),
                                            style: TextStyle(
                                                color: AppColors.primary,
                                                fontWeight: FontWeight.bold,
                                  ...
                                  Center(
                                      child: SizedBox(
                                          width: cubit.invoiceModel!
                                              ...
                                              : null,
                                          child: Text(
                                            cubit.invoiceModel!.allBillmon2!
                                                .toString(),
                                            style: TextStyle(
                                                color: AppColors.primary,
                                                fontWeight: FontWeight.bold,
                        ...
                        cubit.invoiceModel?.allInvoice != null
                            ? ListView.separated(
                                shrinkWrap: true,
                                physics: const BouncingScrollPhysics(),
                                itemBuilder: (context, index) => invoiceItem(
                                    cubit.invoiceModel!.allInvoice![index]),
                                separatorBuilder: (context, index) =>
                                    const SizedBox(
                                      height: 15,
                                    ),
                                itemCount:
                                    cubit.invoiceModel!.allInvoice!.length)
                            : search
            ...
            Column(
              ...
              children: [
                SizedBox(
                    ...
                    child: TextWidget(value: model.description!)),
